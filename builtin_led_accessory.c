...
void led_brightness_setter(homekit_value_t value);
...
homekit_characteristic_t led_brightness = HOMEKIT_CHARACTERISTIC_(BRIGHTNESS, 100, .setter=led_brightness_setter);
...
void led_brightness_setter(homekit_value_t value) {
    ...
    led_brightness.value.int_value = brightness;
    printf("Set Builtin-LED Brightness to %d\n", brightness);
}
